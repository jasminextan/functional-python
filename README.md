# Functional Python [![](https://github.com/jasminextan/functional-python/workflows/tests/badge.svg)](https://github.com/jasminextan/functional-python/actions?query=workflow%3Atests)
